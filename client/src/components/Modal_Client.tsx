                ...
                <form >
                    ...
                    <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <label  className="block text-sm font-medium leading-6 text-gray-900">Genre</label>
                            <select id="genre" name="genre"  value={genre} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                            <option>Male</option>
                        ...
                        <div className="sm:col-span-2">
                                ...
                                name='files'  
                                multiple={true}  
                                className='text-black hover:bg-blue-400 text-center'/>
                        </div>
                    </div>
